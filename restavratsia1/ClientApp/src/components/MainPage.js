    ...
    render() {
        return (
            <div>
                ...
                <section id="sec2" className="section lg-section-height-2x background-responsive">
                    <div className="container col-10 flex-row-center flex-lg-column background-responsive">
                        <div className="col-7 col-lg-9 col-md-12 col-sm-12 align-items-start d-flex justify-content-center">
                            <div id="text-block" className="">
                ...
                >
                    <div
                        id="block1-sec3" 
                        className="container col-9 col-md-11 col-sm-12 flex-center background-transparent background-responsive"
                    >
                        <div
                            id="text-sec3"
                ...
                <section id="sec4" className="section  lg-section-height-2x background-responsive">
